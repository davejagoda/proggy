...
class Bicycle(object):
    ...
    def __init__(
        self, name, chainring_teeth=[44], cog_teeth=[16], tire_size=700, tire_units="mm"
    ):
        self.name = name
...
if "__main__" == __name__:
    bikes = [
        Bicycle("fixie"),
        Bicycle("road", chainring_teeth=[52, 42], cog_teeth=[13, 15, 17, 19, 21, 23]),
    ]
    for bike in bikes:
        print(bike)
