...
def handleArguments():
    ...
    parser.add_argument(
        ...
        "--difference",
        action="store_true",
        help="show the difference of the 2 files",
    )
    parser.add_argument(
        "-i",
        "--intersection",
        action="store_true",
        help="show the intersection of the 2 files",
    )
    parser.add_argument(
        "-u", "--union", action="store_true", help="show the union of the 2 files"
    )
    parser.add_argument(
        "-v",
        "--verbose",
        action="store_true",
        help="show the sets generated from the files",
    )
